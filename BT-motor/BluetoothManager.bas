...
Public Sub SendMessage (msg As String)	'string
...
Private Sub AStream_NewData (Buffer() As Byte)
	CallSub2(motor, "NewMessage", Buffer)
	'CallSub2(io, "NewMessage", BytesToString(Buffer, 0, Buffer.Length, "UTF8"))
...
Private Sub NotifyOfStateChanged
	For Each Target In Array(Main,motor)	
